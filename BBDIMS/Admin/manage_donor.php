...
<div class="container-fluid">
	<form action="<?php echo $_SERVER['PHP_SELF'] ?>" id="manage-donor">
		<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
		<div class="form-group">
			<label for="" class="control-label">Full Name</label>
			<input type="text" class="form-control" name="name" value="<?php echo isset($name) ? $name : '' ?>" pattern="^(\w\w+)\s(\w+)$" required="required" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="contact" value="<?php echo isset($contact) ? $contact : '' ?>" pattern="[0-9]{3}[0-9]{3}[0-9]{5}" required>
		</div>
		<div class="form-group">
